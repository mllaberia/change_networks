...
# WNODF
wilcox.test(null_swap_whole_azov[,1], null_swap_whole_japan[,1], conf.int = TRUE, conf.level = 0.95)
# Q
wilcox.test(null_swap_whole_azov[,2], null_swap_whole_japan[,2], conf.int = TRUE, conf.level = 0.95)
